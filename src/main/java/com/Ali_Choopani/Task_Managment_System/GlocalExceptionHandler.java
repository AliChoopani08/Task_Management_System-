...
public class GlocalExceptionHandler {
    ...
    @ExceptionHandler(InvalidDevice.class)
    public ResponseEntity<ErrorResponse> invalidDeviceHandler(InvalidDevice ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ErrorResponse> duplicateRefreshTokenHandler(DuplicateRefreshToken ex, HttpServletRequest request) {
